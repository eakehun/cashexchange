...
public interface TradingRepository extends JpaRepository<Trading, Long> {
	...
	@Query(value = "SELECT td.idx, td.comeplete_price, td.company, td.create_date, td.fees, td.pin_complete_date"
			...
			+ "td.withdraw_complete_date, td.message, td.purchase_fee_percents, td.tel \r\n"
	...
	@Query(value = "SELECT td.idx, td.comeplete_price, td.company, td.create_date, td.fees, td.pin_complete_date"
			+ ",request_price, td.status, td.withdraw_status, td.update_date, td.user_id, td.user_name, td.withdraw_complete_date, td.message, td.purchase_fee_percents, td.tel \r\n"
			+ "FROM trading as td left join pin_code as pin on td.idx = pin.trading_idx \r\n"
	...
	@Query(value = "SELECT * FROM cashexchange.trading where create_date between :fromDate and :toDate group by user_id", nativeQuery = true)
	List<Trading> findByCreateDateBetweenAndGroupByUserId(Date fromDate, Date toDate);

	@Query(value = "SELECT sum(request_price) as request_price, sum(comeplete_price) as complete_price FROM cashexchange.trading where create_date between :fromDate and :toDate", nativeQuery = true)
	Map<String, Object> findByCreateDateBetweenAndSumPrice(Date fromDate, Date toDate);

	@Query(value = "SELECT td.idx, td.comeplete_price, td.company, td.create_date, td.fees, td.pin_complete_date"
			+ ",request_price, td.status, td.withdraw_status, td.update_date, td.user_id, td.user_name, td.withdraw_complete_date, td.message \r\n"
			+ "FROM trading as td left join pin_code as pin on td.idx = pin.trading_idx \r\n"
