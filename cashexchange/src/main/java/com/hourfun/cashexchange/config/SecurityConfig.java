...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http
			.addFilterAt(customRememberMeFilter(), RememberMeAuthenticationFilter.class)
			.cors()
			.and()
			.csrf()
			...
			.and()
			.rememberMe()				
				.rememberMeServices(customSecurityRememberMeService())				
			.and()			
            .logout()
            	.logoutUrl("/logout")
	...
	public void configure(WebSecurity web) throws Exception {
		...
		web
			.ignoring()
				.antMatchers("/users/login/**").antMatchers("/users/findId/**").antMatchers("/users/findPassword/**").antMatchers("/users/signin/")
				.antMatchers("/admin/login/**").antMatchers("/admin/findId/**").antMatchers("/admin/findPassword/**").antMatchers("/admin/signin/")
				.antMatchers("/manager/login/**").antMatchers("/manager/findId/**").antMatchers("/manager/findPassword/**").antMatchers("/manager/signin/");
